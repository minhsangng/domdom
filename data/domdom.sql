...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2024 at 05:48 AM
...
(1, 'Gà rán', 'Gà rán', 30000.00, 0, 1, 'Món gà rán giòn thơm ngon', 'Chiên gà bằng nồi chiên 180 độ C trong 15 phút đến khi lớp da giòn', 'garan.png'),
...
(24, 1, 11, '2024-10-29', 0),
(25, 2, 16, '2024-10-29', 0),
(26, 1, 11, '2024-10-30', 1),
(27, 2, 16, '2024-11-02', 0),
(28, 1, 10, '2024-10-31', 0),
(29, 2, 10, '2024-11-05', 0),
(30, 1, 7, '2024-11-09', 0),
(31, 2, 7, '2024-11-07', 0),
(32, 1, 2, '2024-11-04', 0),
(33, 1, 10, '2024-11-02', 0),
(34, 2, 10, '2024-10-30', 1),
(35, 1, 8, '2024-10-31', 0),
(36, 2, 15, '2024-11-01', 0),
(37, 2, 11, '2024-11-04', 0);
...
(1, '2024-10-29', 0.00, 150000.00, 6, 'Tiền mặt', NULL, 0, 1),
(2, '2024-10-29', 0.00, 120000.00, 4, 'Thẻ', NULL, 3, 2),
(3, '2024-10-30', 0.00, 30000.00, 2, 'Thẻ', NULL, 3, 3);
...
(2, 'Gói tiệc gia đình', 750000.00, 'gapmat.png', '');
...
--
ALTER TABLE `employee_shift`
  MODIFY `employeeshiftID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `partypackage`
  MODIFY `partyPackageID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
