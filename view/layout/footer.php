        ...
        <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
            <div class="mx-auto max-w-sm lg:max-w-none">
                ...
                <div class="mt-6 flex gap-4">
                    ...
                    <a
                        ...
                        <svg class="size-6" fill="currentColor" width="800px" height="800px" viewBox="0 0 512 512" id="icons" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
                ...
                <div>
                    ...
                    <ul class="mt-6 space-y-1">
                        <li>
                            <a class="text-gray-700 transition hover:text-gray-700/75" href="#">12 Nguyen Van Bao, GV</a>
                        </li>
                        <li>
                            <a class="text-gray-700 transition hover:text-gray-700/75" href="#">(028) 2236 4456</a>
                        </li>
                        <li>
                            <a class="text-gray-700 transition hover:text-gray-700/75" href="#">contact@fireflies.gmail.com</a>
                        </li>
                    </ul>
                </div>
