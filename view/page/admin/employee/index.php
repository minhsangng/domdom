                        ...
                        <table class="w-full">
                            <tr>
                                <td>
                                    ...
                                    <input type="text" class="w-full form-control" name="userName" required pattern="^[\p{L}\s]+$" title="Họ tên chỉ được nhập chữ cái">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label for="email" class="w-full py-2"><b>Email <span
                                                class="text-red-500">*</span></b></label>
                                    <input type="email" class="w-full form-control" name="email" required pattern="[a-zA-Z0-9._%+-]+@domdom\.vn" title="Email phải đúng định dạng: example@domdom.vn">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label for="sex" class="w-full py-2"><b>Giới tính <span
                                                class="text-red-500">*</span></b></label>
                                    <input type="radio" class="mr-1" name="sex" value="1" id="male" required><label for="male"
                            ...
                            <tr>
                                <td>
                                    <label for="role" class="w-full py-2" ><b>Vai trò <span
                                                class="text-red-500">*</span></b></label>
                                    <input type="radio" class="mr-1" name="role" value="2" id="qlch" required><label for="qlch"
                                        class="mr-4">QL cửa hàng</label>
                                    <input type="radio" class="mr-1" name="role" value="3" id="nvnd" required><label for="nvnd"
                                        class="mr-4">NV nhận đơn</label>
                                    <input type="radio" class="mr-1" name="role" value="4" id="nvb" required><label for="nvb">NV
                                        bếp</label>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="w-full">
                            <tr>
                                <td>
                                    ...
                                    <input type="text" class="w-full form-control" name="userName" required pattern="^[\p{L}\s]+$" title="Họ tên chỉ được nhập chữ cái tiếng Việt"
