    <div class="grid grid-cols-1 md:grid-cols-1 gap-6 mt-8">
        <div class="bg-white p-6 rounded-lg shadow-lg mb-6">
            <div class="flex justify-between items-center mb-4">
                <form action="" method="POST" class="flex justify-center items-center pt-3">
                    <input type="checkbox" name="" id="" class="mr-2 size-4"><label for="" class="mr-4">CH 1</label>
                    <input type="checkbox" name="" id="" class="mr-2 size-4"><label for="" class="mr-4">CH 2</label>
                    <input type="checkbox" name="" id="" class="mr-2 size-4"><label for="" class="mr-4">CH 3</label>
                    <input type="checkbox" name="" id="" class="mr-2 size-4"><label for="" class="mr-4">CH 4</label>
                    <input type="checkbox" name="" id="" class="mr-2 size-4"><label for="" class="mr-4">CH 5</label>
                </form>
