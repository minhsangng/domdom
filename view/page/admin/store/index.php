                        ...
                        <table class="w-full">
                            <tr>
                                <td>
                                    ...
                                    <input type="text" class="w-full form-control" name="storeName" value="<?php echo $_SESSION["storeName"]; ?>" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="address" class="w-full py-2"><b>Địa chỉ</b></label>
                                    <input type="text" class="w-full form-control" name="address" value="<?php echo $_SESSION["address"]; ?>" required>
                                </td>
                            </tr>
                            <tr>
                                <td>
