    ...
    <div class="bg-white p-6 rounded-lg shadow-lg mb-6">
        <div class="flex justify-between items-center mb-4">
            <div class="flex items-center w-fit">
                <select name="" id="categorySelector" class="form-control" onchange="location = this.value;">
                    <option value="">Tất cả</option>
                    <option value="#dtbh">Bán hàng</option>
                    <option value="#cpnc">Nhân công</option>
                    <option value="#cpnl">Nguyên liệu</option>
        ...
        <div class="flex justify-between items-center my-4 w-full" id="dtbh">
            ...
            <table class="text-base w-full text-center">
                <thead>
                    <tr>
                        ...
                        <th class="text-gray-600 border-2 py-2">Tổng hóa đơn</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
...
SELECT 
    O.orderDate, 
    CONCAT(D.dishName, ' (x', OD.quantity, ')') AS dishes, 
    OD.quantity AS sumOfQuantity, 
    O.total
FROM `order` AS O
JOIN `order_dish` AS OD ON OD.orderID = O.orderID
JOIN `dish` AS D ON D.dishID = OD.dishID
...
";
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="text-center border-2"><!-- <?php echo str_replace(".00", "", number_format($revenue, "2", ".", ",")); ?> --></td>
                    </tr>
                </tfoot>
            </table>
        </div>
        <div class="flex justify-between items-center my-4 w-full" id="cpnc">
        ...
        <div class="flex justify-between items-center my-4 w-full" id="cpnl">
        ...
        <div class="flex justify-between items-center my-4 w-full" id="ln">
